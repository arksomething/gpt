...
COMMANDS = [
    ...
    {
        "name": "prepare-data",
        "description": "Prepare memmapped token data from C4 + Wikipedia.",
        "args": [
            ...
            ("--c4_weight", "0.9", "C4 dataset sampling weight"),
            ("--wiki_weight", "0.1", "Wikipedia dataset sampling weight"),
    ...
    },
    {
        ...
        "description": "Train a SentencePiece BPE tokenizer from C4 + Wikipedia.",
        "args": [
