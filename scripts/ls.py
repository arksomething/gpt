...
COMMANDS = [
    ...
    {
        "name": "prepare-data",
        "description": "Prepare memmapped token data from C4 + Wikipedia + FineWeb (filtered).",
        "args": [
            ...
            ("--wiki_weight", "0.50", "Wikipedia dataset sampling weight"),
            ("--fineweb_weight", "0.20", "FineWeb dataset sampling weight"),
            ("--gutenberg_weight", "0.00", "Deprecated alias for --fineweb_weight"),
    ...
    },
    {
        ...
        "description": "Train a SentencePiece BPE tokenizer from C4 + Wikipedia + FineWeb.",
        "args": [
