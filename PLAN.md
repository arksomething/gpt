...
| 2026-07-31 | Gate 1 CLOSED. Shipped mixture: B0.1 with conversation at 24% (P2). Winner-confirm at 3 seeds gives P2 3.6297 vs B0 3.6366, −0.0069 = 0.87σ — within noise, but negative on all three seeds and with a tighter spread (0.0057 vs 0.0079) | Ten runs, ~$11, all off one union corpus so mixture was the only variable, decision rule predeclared. The result in one line: narrowing the distribution reliably loses (P1 1.86σ, P3 2.24σ, P5 2.83σ, P4 3.31σ — all reallocated mass) while adding a conversational register is free. Gate 2 baseline is frozen on this mixture |
